...
const Clients: React.FC = () => {
    const publicClients = [
        { name: "Sokoto State Government", service: "SFTAS World Bank Programme 2020-2023", domain: "sokotostate.gov.ng", logo: "/clients/sokoto_state.jpg" },
        { name: "Sokoto State Ministry of Finance", service: "Payroll Forensic Audit & Investigation", domain: "finance.sokotostate.gov.ng", logo: "/clients/sokoto_state.jpg" },
        { name: "Lagos Lotteries & Gaming Authority", service: "External Auditor", domain: "lslga.org", logo: "/clients/lagos_lotteries.png" },
        { name: "Lagos Neighbourhood Watch Agency", service: "External Auditor", domain: "lnwa.lagosstate.gov.ng", logo: "/clients/lagos_state.png" },
        { name: "Wharf Landing Fees Collecting Authority", service: "External Auditor", domain: "lagosstate.gov.ng", logo: "/clients/lagos_state.png" },
        ...
        { name: "Revenue Mobilization Allocation and Fiscal Commission", service: "Revenue Collection Verification", domain: "rmafc.gov.ng", logo: "/clients/rmafc.jpg" },
        { name: "Olabisi Onabanjo University Ventures", service: "External Auditor", domain: "oouagoiwoye.edu.ng", logo: "/clients/oou_logo.png" },
        { name: "Niger State Development Company", service: "Joint Investigator (Shares/Dividends)", domain: "nigerstate.gov.ng", logo: "/clients/nsdc.png" }
    ];
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {publicClients.map((c, i) => (
                                <div key={i} className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 hover:bg-white hover:shadow-xl transition-all flex items-start gap-4 group">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {privateClients.map((c, i) => (
                                <div key={i} className="p-8 bg-white rounded-[2.5rem] border border-slate-100 hover:shadow-xl transition-all flex items-start gap-4 group">
